...
{
    /**
     * Tentukan apakah user berwenang mengubah pengajuan ini.
     * Hanya staf pemilik pengajuan dan saat status draft, diajukan, atau dikembalikan.
     */
    public function authorize(): bool
    {
        ...
        return $this->user()
            ...
            && $pengajuan->canBeModifiedByStaf();
    }

    /**
     * Aturan validasi pembaruan data pengajuan surat.
     *
