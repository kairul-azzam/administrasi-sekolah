...
<head>
    ...
    <title>403 - Akses Ditolak | Sistem Administrasi Sekolah</title>
    <!-- Fonts -->
...
<body class="h-full flex flex-col justify-center items-center px-4 py-12 bg-stone-50 font-sans">
    <div class="w-full max-w-md text-center">
        <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-rose-50 text-rose-600 mb-6 border border-rose-100 shadow-xs">
            <x-icon.x-circle class="w-8 h-8" />
        </div>

        <span class="text-xs font-semibold text-rose-600 uppercase tracking-widest block mb-1">
        ...
        <p class="text-xs text-stone-600 mt-2.5 leading-relaxed">
            {{ $exception->getMessage() ?: 'Anda tidak memiliki hak akses atau wewenang untuk membuka tautan halaman ini.' }}
        </p>
